...
namespace AccountService_API.Services.Implementations
{
    public class AccountService : IAccountService
    {
        ...
        public async Task<bool> ActivateUserAccount(string userId)
        {
            if (!string.IsNullOrWhiteSpace(userId.Trim()))
            {
                try
                {
                    ...
                    // Activate user properties based on your model
        ...
        /// <returns></returns>
        private ApplicationRoleDto ReturnApplicationRoleDto(Role model)
        {
        ...
        private ApplicationUserDto ReturnApplicationUserDto(User model)
        {
